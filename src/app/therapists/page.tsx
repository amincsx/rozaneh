...
const mockTherapists: Therapist[] = [
    ...
    },
    {
        "id": "2",
        "name": "زینب ایرانی",
        "specializations": ["چالش‌های فردی و تصمیم‌گیری", "سوگ و فقدان", "مدیریت هیجانات و خشم", "عزت‌نفس و خودباوری", "مشکلات ارتباطی و بین‌فردی", "وسواس فکری و عملی", "افسردگی و مشکلات خلقی", "اضطراب، استرس و نگرانی‌های مزمن"],
        "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        "id": "3",
        "name": "زهره کیانی",
        "specializations": ["همگی به جز مشکلات فرزند پروری و بیش فعالی"],
        "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        "id": "5",
        "name": "الهام عسگری",
        "specializations": ["فردی ", "زوج ", "پیش از ازدواج"],
        "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        "id": "6",
        "name": " مینا خضری نمین",
        "specializations": ["خانواده", "زوج", "فردی"],
        "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        "id": "7",
        "name": "زهرا بیکی",
        "specializations": ["کودک ", "فرزند پروري", "خانواده درمانی"],
        "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        "id": "8",
        "name": "دکتر رضا معیری",
        "specializations": ["زوج درمانی (تعارض های زناشویی و مشاوره پیش از ازدواج)", "درمان فردی (اضطراب، تنظیم هیجان، افسردگی و اختلالات خلقی)",],
        "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        "id": "9",
        "name": "مهسا باغبانی",
        "specializations": ["مشاوره فردی برای مراجعین بزرگسال", "درمان اضطراب افسردگی "],
        "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        "id": "10",
        "name": "مژگان میرزاده",
        "specializations": ["كودك و بزرگسال",],
        "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        "id": "12",
        "name": "سارا گلچوبیان",
        "specializations": ["فردی (اضطراب ، افسردگی ، وسواس )", "زوجی و خانواده :شکست عاطفی ، خیانت .....تعارض ..."], "rating": 4.5, "experience": 10, "hourlyRate": 300000,
        "bio": "سارا گلچوبیان - متخصص مشاوره فردی", "image": "/psychologists/12/image (9).webp", "languages": ["فارسی"], "availableSlots": 10
    },
    {
        "id": "13",
        "name": "زهرا صادقی",
        "specializations": [" وسواس، تروما", "افسردگی ", "اختلالات اضطرابی", "نوجوان ", "فردی"],
        "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        ...
        "specializations": [" افسردگی و اختلالات خلقی ", "تنظیم هیجان", "درمان زوجی تعارض های زناشویی و پیش از ازدواج", "درمان فردی اضطراب"],
        "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        ...
        "specializations": ["مشاوره پیش از ازدواج، زوج و خانواده درمانی", "سکس تراپی", "زندگی مشترک و تعارضات زوجین", "خیانت و بازسازی رابطه", "مشکلات فرزندپروری", "گروه درمانی", "اضطراب، وسواس فکری و عملی، افسردگی، تنظیم هیجان، سوگ و فقدان"],
        "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        ...
        "specializations": ["مشاوره خانواده", "زوج درمانی", "مشاوره فردی", "مشاوره پیش از ازدواج", "مشاوره نوجوان", "مداخله در سوگ", "مهارت های فرزندپروری", "سکس تراپیست", "تعارضات و خیانت"],
        "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        ...
        "specializations": ["سوگ و فقدان", "شکست‌های عاطفی و روابط", "چالش‌های تحصیلی و انتخاب مسیر یادگیری", "مدیریت اضطراب و استرس", "افزایش مهارت‌های خودآگاهی و خوداتکایی", "کنترل هیجان و مهارت‌های میان‌فردی", "حل تعارض و تصمیم‌گیری در زندگی شخصی"], "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        ...
        "specializations": ["روان تحلیلی روابط ابژه", "سکس تراپی", "خانواده درمانی", "زوج درمانی", "مشاوره قبل ازدواج", "کودک و نوجوان", "درمانهای موج سوم", "درمان اصالتی", "درمان سوگ", "درمان راه حل محور", "بیماری های مزمن و روان تنی"], "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        ...
        "specializations": ["اختلالات فردی", "خانواده درمانی"], "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        ...
        "specializations": ["زوج‌درمانی", "خانواده", "فردی", "پیش‌از ازدواج"], "rating": 4.5, "experience": 10, "hourlyRate": 300000,
        "bio": "متخصص روانشناسی بالینی - - مشاوره فردی  در خصوص اختلالات شخصیت( وسواس ، اضطراب، افسردگی و .. ) - مشاوره پیش از ازدواج - زوج و خانواده درمانی",
    ...
    },
    {
        "id": "23",
        "name": "فاطمه ماه روح ",
        "specializations": [" زوجی ( خانواده ) ", "پیش از ازدواج", "فردی", "نوجوان"], "rating": 4.5, "experience": 10, "hourlyRate": 300000,
        "bio": "متخصص روانشناسی بالینی - - مشاوره فردی  در خصوص اختلالات شخصیت( وسواس ، اضطراب، افسردگی و .. ) - مشاوره پیش از ازدواج - زوج و خانواده درمانی",
    ...
    },
    {
        "id": "24",
        "name": "یاسمن طبائیان ",
        "specializations": ["مشاوره فردی", "زوج درمانی", "مشاوره ازدواج",], "rating": 4.5, "experience": 10, "hourlyRate": 300000,
        "bio": "متخصص روانشناسی بالینی - - مشاوره فردی  در خصوص اختلالات شخصیت( وسواس ، اضطراب، افسردگی و .. ) - مشاوره پیش از ازدواج - زوج و خانواده درمانی",
    ...
    },
    {
        ...
        "specializations": ["بزرگسال", "فردی", "مسائل بین فردی و ارتباطی", "رشد و توسعه فردی"], "rating": 4.5, "experience": 10, "hourlyRate": 300000,
        "bio": "متخصص روانشناسی بالینی - - مشاوره فردی  در خصوص اختلالات شخصیت( وسواس ، اضطراب، افسردگی و .. ) - مشاوره پیش از ازدواج - زوج و خانواده درمانی",
    ...
    },
    {
        ...
        "specializations": ["زوج درمانگر", "مشاوره تخصصی ازدواج", "غنی سازی رابطه زوجین", "حل تعارض زوجین"], "rating": 4.5, "experience": 10, "hourlyRate": 300000,
        "bio": "متخصص روانشناسی بالینی - - مشاوره فردی  در خصوص اختلالات شخصیت( وسواس ، اضطراب، افسردگی و .. ) - مشاوره پیش از ازدواج - زوج و خانواده درمانی",
    ...
    },
    {
        "id": "27",
        "name": "ساناز شاهوردی ",
        "specializations": ["مدیریت هیجان", "افسردگی", "اضطراب", "مشکلات روابط بین‌فردی"], "rating": 4.5, "experience": 10, "hourlyRate": 300000,
        "bio": "متخصص روانشناسی بالینی - - مشاوره فردی  در خصوص اختلالات شخصیت( وسواس ، اضطراب، افسردگی و .. ) - مشاوره پیش از ازدواج - زوج و خانواده درمانی",
