...
const mockTherapists: Therapist[] = [
    ...
    },
    {
        ...
        "specializations": ["مشاوره فردی پنیک، افسردگی، اضطراب، وسواس و ...", "مشاوره زوج و خانواده درمانی تعارضات زناشویی و..", "درمانگر نوجوان", "مشاوره پیش از ازدواج"],
        "rating": 4.5, "experience": 10, "hourlyRate": 300000,
    ...
    },
    {
        ...
        "specializations": [" اختلالات اضطرابی - ارتقای رشد و توسعه فردی - بزرگسالان - درمان اختلالات افسردگی  "], "rating": 4.5, "experience": 10, "hourlyRate": 300000,
        "bio": "متخصص روانشناسی بالینی - - مشاوره فردی  در خصوص اختلالات شخصیت( وسواس ، اضطراب، افسردگی و .. ) - مشاوره پیش از ازدواج - زوج و خانواده درمانی",
    ...
    },
    {
        "id": "24",
        "name": "یاسمن طبائیان ",
        "specializations": [" مشاوره فردی - زوج درمانی - مشاوره ازدواج - خانواده درمانگر بزرگسالان   "], "rating": 4.5, "experience": 10, "hourlyRate": 300000,
        "bio": "متخصص روانشناسی بالینی - - مشاوره فردی  در خصوص اختلالات شخصیت( وسواس ، اضطراب، افسردگی و .. ) - مشاوره پیش از ازدواج - زوج و خانواده درمانی",
